...
ATTENTION! If you would like to submit an CIP and it has already been written as a draft (see the [template](https://github.com/FIXME/CIPs/blob/master/cip-template.md) for an example), please submit it as a [Pull Request](https://github.com/FIXME/CIPs/pulls).
