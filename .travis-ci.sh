...
HTMLPROOFER_OPTIONS="./_site --internal-domains=hub.gamecredits.org --check-html --check-opengraph --report-missing-names --log-level=:debug --assume-extension --empty-alt-ignore --timeframe=6w --url-ignore=/cips/cip-1,cips/cip-1,/cips/cip-107,/cips/cip-858"
